...
const UserOngoing = () => {
  ...
  const courtcoachRender = (res: any) => {
    return (
      <h2 className="table-avatar">
        <Link to="#" className="avatar avatar-sm flex-shrink-0">
                          ...
                          <div className="table-responsive table-datatble">
                            ...
                            >
                              ...
                              <Column
                                ...
                                header="Date & Time"
                              ></Column>
                              <Column sortable field="payment" header="Payment"></Column>
                              <Column
                                sortable
                                field="details"
                                body={detailsRender}
                        ...
                        <div className="profile-set-content">
                          ...
                          <div className="rating-city">
                            ...
                            <div className="profile-set-img">
                              <ImageWithBasePath src="assets/img/flag/usa.png" alt="Profile" />
                          ...
                          <div className="profile-card mb-0">
                            ...
                            <div className="profile-card-content">
                              <p>
                                ...
                                ipsum dolor sit amet, consectetur adipiscing elit. Varius
                                consectetur a at est diam ultricies. Egestas eros leo dapibus tellus
                                neque turpis. Nec in morbi adipiscing pretium accumsan urna ac,
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div className="accordion" id="accordionPanel">
                                ...
                                <div className="accordion-body">
                                  <div className="text show-more-height">
                                    ...
                                    <ul>
                                      ...
                                      <li>
                                        I grew up at North Venice Little League and represented
                                      </li>
                            ...
                            <div className="accordion-item mb-4" id="lesson-with-me">
                              <h4 className="accordion-header" id="panelsStayOpen-lesson-with-me">
                                <button
                                  className="accordion-button"
                                  type="button"
                                  data-bs-toggle="collapse"
                        ...
                        >
                          <div className="review-box review-box-user d-flex">
                            ...
                            <div className="review-info">
                              ...
                              <h6>Absolutely perfect</h6>
                              <p>
                                If you are looking for a perfect place for friendly matches with
                                your friends or a competitive match, It is the best place.
                              </p>
                            ...
                            <div className="accordion-item mb-4">
                              ...
                              <div className="accordion-collapse ">
                                <div className="accordion-body">
                                  ...
                                  <p>
                                    <i className="feather-alert-octagon text-danger me-2" />A
                                    maximum number of members per booking per cricket court is
