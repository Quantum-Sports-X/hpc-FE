...
const UserComplete = () => {
  ...
  return (
    <div>
                        ...
                        <div className="table-responsive table-datatble">
                          ...
                          >
                            <Column
                              ...
                              header="Coach Name"
                            ></Column>
                            <Column sortable field="bookingType" header="Booking Type"></Column>
                            <Column
                              sortable
                              field="location"
                              className="table-date-time"
      ...
      {/* /Page Content */}
      {/* complete Modal */}
      <div className="modal custom-modal fade request-modal" id="complete-court" role="dialog">
                  ...
                  <div className="card dashboard-card court-information">
                    ...
                    <div className="user-review-details">
                      ...
                      <div className="user-review-content">
                        ...
                        <p>
                          If you are looking for a perfect place for friendly matches with your
                          friends or a competitive match, It is the best place.
                        </p>
      ...
      {/* /complete Modal */}
      {/* complete Modal */}
      <div className="modal custom-modal fade request-modal" id="complete-coach" role="dialog">
        <div className="modal-dialog modal-dialog-centered modal-md">
          <div className="modal-content">
            <div className="modal-header">
              <div className="form-header modal-header-title">
                  ...
                  <div className="card dashboard-card court-information">
                    <div className="profile-set">
                      <div className="profile-set-image">
                        <ImageWithBasePath src="assets/img/featured/featured-05.jpg" alt="Venue" />
                      </div>
                      <div className="profile-set-content">
                        ...
                        <div className="rating-city">
                          ...
                          <div className="profile-set-img">
                            <ImageWithBasePath src="assets/img/flag/usa.png" alt="User" />
                        ...
                        <ul>
                          <li>
                            <ImageWithBasePath src="assets/img/icons/rank.svg" alt="Icon" />
                            <h6>Rank : Expert</h6>
                          </li>
                          <li>
                            <ImageWithBasePath src="assets/img/icons/process.svg" alt="Icon" />
                            <h6>Sessions Completed : 25</h6>
                          </li>
                          <li>
                            <ImageWithBasePath src="assets/img/icons/calendar-alt.svg" alt="Icon" />
                            <h6>
                        ...
                        <div className="profile-card mb-0">
                          ...
                          <div className="profile-card-content">
                            <p>
                              ...
                              ipsum dolor sit amet, consectetur adipiscing elit. Varius consectetur
                              a at est diam ultricies. Egestas eros leo dapibus tellus neque turpis.
                              Nec in morbi adipiscing pretium accumsan urna ac,Lorem ipsum dolor sit
                              amet, consectetur adipiscing elit. Varius consectetur a at est diam
                              ultricies. Egestas eros leo dapibus tellus neque turpis. Nec in morbi
                      ...
                      >
                        ...
                        <div className="accordion">
                          <div className="accordion-item mb-4">
                            ...
                            <div id="panelsStayOpen-collapseOne" className="accordion-collapse">
                              <div className="accordion-body">
                                <div className="text show-more-height">
                                  ...
                                  <ul>
                                    ...
                                    <li>3 years of college club cricket at Loyola Marymount</li>
                                    <li>I grew up at North Venice Little League and represented</li>
                                    <li>Southern California in 2017 for Senior State Champs.</li>
                                    <li>
                                      3 years on Varsity at Venice High School. Venice Varsity
                                    </li>
                                    <li>cricket Western League Champs 2017.</li>
                                    <li>2 years of Loyola Marymount University Club cricket.</li>
                                  </ul>
                                  <p>
                          ...
                          <div className="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseSeven" className="accordion-collapse">
                              <div className="accordion-body">
                          ...
                          <div className="info">
                            ...
                            <div className="profile-set-content w-100 p-0">
                              <ul className="bg-transparent p-0">
                                ...
                                <li>
                                  <ImageWithBasePath src="assets/img/icons/call.svg" alt="Icon" />
                                  <h6>+3 80992 31212</h6>
                                </li>
                                <li>
                        ...
                        <div className="accordion">
                          <div className="accordion-item mb-4">
                            <h4 className="accordion-header">
                              <button className="accordion-button" type="button">
                                <span className="icon-bg">
                                  <ImageWithBasePath src="assets/img/icons/Black.svg" alt="Icon" />
                                </span>
                                Overview
                              </button>
                            </h4>
                            ...
                            <div className="accordion-collapse">
                              <div className="accordion-body">
                                <p>
                                  ...
                                  Non Marking Shoes are recommended not mandatory for Cricket.
                                </p>
                                <p>
                                  <i className="feather-alert-octagon text-danger me-2" />A maximum
                                  number of members per booking per cricket court is admissible
                                  fixed by Venue Vendors
                                </p>
                                <p>
                                  <i className="feather-alert-octagon text-danger me-2" />
