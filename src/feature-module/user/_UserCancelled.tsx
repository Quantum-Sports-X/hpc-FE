  ...
  const Render = () => {
    return (
      <span className="badge bg-danger">
        <ImageWithBasePath src="assets/img/icons/delete.svg" alt="Icon" className="me-1" />
        Cancelled
      </span>
    )
  }
                      ...
                      >
                        <div className="table-responsive table-datatble">
                          ...
                          >
                            ...
                            ></Column>
                            <Column sortable field="dateandTime" header="Data & Time"></Column>
                                ...
                                <td>
                                  <h2 className="table-avatar">
                                    ...
                                    <span className="table-head-name flex-grow-1">
                                      ...
                                      <span className="book-active">Booked on : 25 May 2023</span>
                                    </span>
                                  </h2>
                                </td>
                                <td>Onetime</td>
