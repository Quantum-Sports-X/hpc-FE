                    ...
                    <div className="seat-booking">
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-6 col-lg-6">
                          ...
                          <p>
                            There are many people variation of passages of lorem Ipsum available in
                            the majority sed do eius tempor incididunt ut labore etq uiaolor sit
                            amet alteration in some. Quuntur magni dolores eos qui ratione
              ...
              <div className="row">
                <div className="col-12 offset-sm-12 offset-md-2 col-md-8 col-lg-8">
                  <div className="text-center mb-40">
                    <h3>Book an Event</h3>
                    <p>
                      Hi, we are always open for cooperation and suggestions, <br /> contact us in
                  ...
                  <form>
                    <div className="card">
                      ...
                      <div className="d-flex align-items-center justify-content-center">
                        <Link to={route.cageDetails} className="btn btn-secondary btn-icon">
                          Pay Now
