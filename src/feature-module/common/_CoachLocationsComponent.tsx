...
import {constructCoachesPath, getImagePath} from '../../services/commonService'

export const CoachLocationsComponent = () => {
            ...
            <div className="wrapper">
              <div className="listing-item listing-item-grid">
                <div className="listing-img">
                  <Link to={constructCoachesPath(location.slug)}>
                ...
                <div className="listing-content">
                  ...
                  <h3 className="listing-title">
                    <Link to={constructCoachesPath(location.slug)}>{location.name}</Link>
                  </h3>
