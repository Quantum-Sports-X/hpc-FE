...
const ListingMapSidebar = () => {
  ...
  return (
    <div>
              ...
              <div className="map-list-blk">
                            ...
                            <div className="sortby-filter-group">
                              <div className="grid-listview">
                                <ul className="nav">
                                  ...
                                  <li>
                                    <Link to={routes.listingMapSidebar} className="active">
                                      <ImageWithBasePath
                ...
                <div className="sidebar-group">
                  <div className="sidebar-header-left">
                    <button type="button" className="popup-toggle filter-btn" onClick={openSidebar}>
                      <span>
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <h3 className="listing-title">
                            <Link to={routes.bookingType}>Cricket Academy</Link>
                          </h3>
                          <div className="listing-details-group">
                            <p>
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Manchester Academy: Where dreams meet excellence in sports education
                              and training.
                            </p>
                            <ul>
                              <li>
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Achieve your cricket goals at NG Sports. Book your training session
                              now in our futuristic facility.
                            </p>
                            <ul>
                              <li>
                                <span>
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Russ Cricket : Nurturing excellence in cricket education &amp;
                              training.
                            </p>
                            <ul>
                              <li>
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Unlock your athletic potential at Andy&apos;s Sport Academy. Book now
                    ...
                    <div className="featured-venues-item venue-list-item">
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Herique Cricket: Elevate your game. Train with passion at our
                              exclusive facility.{' '}
                            </p>
                            <ul>
                              <li>
      ...
      {/* /Page Content */}
      <div className={`toggle-sidebar listing-page ${isClass ? 'open-sidebar' : ''}`}>
                  ...
                  >
                    <div className="card-body-chat">
                      <div className="filter-range">
                        <Slider className="input-range" min={0} max={100} defaultValue={[0, 50]} />
                      </div>
                    </div>
                  </div>
                </div>
