                          ...
                          <ul className="nav">
                            ...
                            <li>
                              <Link to={routes.listingGrid}>
                                <ImageWithBasePath src="assets/img/icons/sort-01.svg" alt="Icon" />
                              </Link>
                            </li>
                            <li>
                              <Link to={routes.listingList} className="active">
                                <ImageWithBasePath src="assets/img/icons/sort-02.svg" alt="Icon" />
                              </Link>
                            </li>
                            <li>
                              <Link to={routes.listingMap}>
                                <ImageWithBasePath src="assets/img/icons/sort-03.svg" alt="Icon" />
                              </Link>
                            </li>
                          </ul>
                        </div>
                ...
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Sarah Sports Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Elevate your athletic journey at Sarah Sports Academy, where excellence
                        meets opportunity.
                      </p>
                      <ul className="listing-details-info">
                        ...
                        <li>
                          <span>
                            ...
                            Next availablity : <span className="primary-text">21 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
                    <div className="listing-button">
                      ...
                      <Link to={routes.bookingType} className="user-book-now">
                        <span>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Badminton Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Unleash your cricket potential at our premier Cricket Academy, where
                        champions are made.
                      </p>
                      <ul className="listing-details-info">
                        <li>
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">16 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Manchester Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Manchester Academy: Where dreams meet excellence in sports education and
                        training.
                      </p>
                      <ul className="listing-details-info">
                        <li>
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">17 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>NG Sports Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Achieve your cricket goals at NG Sports. Book your training session now in
                        our futuristic facility.
                      </p>
                      <ul className="listing-details-info">
                        <li>
                          <span>
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">20 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Rivan Cricket Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Rivan Cricket Academy: Where dreams soar through excellence in cricket
                        training.
                      </p>
                      <ul className="listing-details-info">
                        <li>
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">19 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Russ Cricket</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Russ Cricket : Nurturing excellence in cricket education &amp; training.
                      </p>
                      <ul className="listing-details-info">
                        <li>
                          <span>
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">18 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Andy’s Sports Academy</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Unlock your athletic potential at Andy&apos;s Sport Academy. Book now at our
                      ...
                      <ul className="listing-details-info">
                        ...
                        <li>
                          <span>
                            <i className="feather-calendar" />
                            Next availablity : <span className="primary-text">15 May 2023</span>
                          </span>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>Herique Cricket</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        Herique Cricket: Elevate your game. Train with passion at our exclusive
                        facility.{' '}
                      </p>
                      <ul className="listing-details-info">
                        <li>
              ...
              <div className="featured-venues-item venue-list-item">
                <div className="listing-item listing-item-grid">
                  ...
                  <div className="listing-content">
                    ...
                    <h3 className="listing-title">
                      <Link to={routes.bookingType}>AG Sports</Link>
                    </h3>
                    <div className="listing-details-group">
                      <p>
                        AG Sports: Ignite your sporting journey. Train with dedication at our
                        premier facility.
                      </p>
                      <ul className="listing-details-info">
                        <li>
