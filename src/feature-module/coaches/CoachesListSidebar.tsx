                      ...
                      <div className="sortby-filter-group">
                        <div className="grid-listview">
                          <ul className="nav">
                            ...
                            <li>
                              <Link to={routes.coachesGridSidebar} className="active">
              ...
              <div className="col-lg-4 theiaStickySidebar">
                <div className="stickybar">
                  <div className="listing-filter-group listing-item">
                    <form action="#" autoComplete="off" className="sidebar-form listing-content">
                      {/* Customer */}
                      ...
                      {/* By Status */}
                      <div className="accordion radius-space" id="accordionMain3">
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Experienced coach dedicated to enhancing your cricket skills and
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Passionate Cricket Coach unlocking players&apos; potential through
                              strategic gameplay
                            </p>
                          </div>
                          <div className="avalbity-review avalbity-review-list">
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Passionate Cricket Coach elevating skills and fostering love for the
                              game.
                            </p>
                          </div>
                          <div className="avalbity-review avalbity-review-list">
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Dedicated Cricket Coach refining players skills and techniques to
                              ignite the game
                            </p>
                          </div>
                          <div className="avalbity-review avalbity-review-list">
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Dedicated cricket expert meticulously perfecting techniques for best
                              results
                            </p>
                          </div>
                          <div className="avalbity-review avalbity-review-list">
                    ...
                    <div className="featured-venues-item">
                      <div className="listing-item listing-item-grid coach-listview">
                        ...
                        <div className="listing-content">
                          ...
                          <div className="listing-details-group">
                            <p>
                              Detail-oriented cricket enthusiast with a patient coaching approach.
                            </p>
                          </div>
                          <div className="avalbity-review avalbity-review-list">
                            <ul>
