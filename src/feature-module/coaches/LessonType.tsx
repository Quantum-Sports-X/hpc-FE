      ...
      <div className="content">
        <div className="container">
          <section className="card mb-40">
            <div className="text-center mb-40">
              ...
              <p className="sub-title">
                Enhance your cricket skills with personalized lessons. Book a coach and elevate your
                game.
              </p>
            </div>
          ...
          <section className="card">
            <ul className="d-flex lesson-types">
              <li className={activeButton === 1 ? 'active' : ''}>
                ...
                <p>
                  3 Days * 1 hour @ <span className="primary-text">$150.00</span>
                </p>
              </li>
              ...
              <li className={activeButton === 2 ? 'active' : ''}>
                ...
                <p>
                  4 Days * 1 hour @ <span className="primary-text">$150.00</span>
              ...
              <li className={activeButton === 3 ? 'active' : ''}>
                ...
                <p>
                  2 Days * 1 hour @ <span className="primary-text">$200.00</span>
          ...
          <div className="text-center btn-row">
            ...
            <Link className="btn btn-secondary btn-icon" to={routes.lessonTimeDate}>
