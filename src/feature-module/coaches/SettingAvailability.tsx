              ...
              <ul className="nav">
                ...
                <li>
                  <Link
                    ...
                    className={isLinkActive(route.settingAvalibilty) ? 'active' : ''}
                  >
                    Availability
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isLinkActive(route.settingPassword) ? 'active' : ''}
                  >
                    Change Password
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isLinkActive(route.profileOtherSetting) ? 'active' : ''}
                  >
                    Other Settings
                  </Link>
                </li>
                          ...
                          >
                            <div className="interset-btn empty-space">
                              <div className="status-toggle d-inline-flex align-items-center">
                                <input type="checkbox" id={`status_${day}`} className="check" />
                                <label htmlFor={`status_${day}`} className="checktoggle">
                                  checkbox
                                </label>
                              </div>
                            </div>
