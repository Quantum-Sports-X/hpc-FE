...
const AddCourt = () => {
  ...
  const courtOptions = [{name: 'Select Court Type'}, {name: 'Toronto'}, {name: 'Texas'}]
  const hoursOptions1 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions2 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions3 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions4 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions5 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions6 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
  const hoursOptions7 = [{name: '1 Hrs'}, {name: '2 Hrs'}, {name: '3 Hrs'}]
            ...
            <div className="col-12 col-sm-12 col-md-12 col-lg-12">
              <div className="venue-options option-list-court white-bg">
                <ul className="clearfix">
                  <li className="active">
                    <Link onClick={() => scrollContent('basic-info')}>Basic Info</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('venue-price')}>Venue Price</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('availability')}>Availability</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('overview')}>Overview</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('includes')}>Includes</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('rules')}>Rules</Link>
                  </li>
                  <li>
                    <Link onClick={() => scrollContent('amenities')}>Amenities</Link>
                  </li>
                  <li>
              ...
              <form action="#" className="accordion" id="accordionPanel">
                          ...
                          <div className="profile-availability">
                            ...
                            <div className="accordion setting-accordion">
                                      ...
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours1(e.value)}
                              ...
                              >
                                ...
                                <div id="tuesday" className="accordion-collapse collapse show">
                                  <div className="accordion-body">
                                    <div className="row gx-2">
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours2(e.value)}
                                      ...
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours3(e.value)}
                                      ...
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours4(e.value)}
                                      ...
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours5(e.value)}
                                      ...
                                      <div className="col-md-3">
                                        <div className="duration-blk">
                                          ...
                                          <Dropdown
                                            ...
                                            onChange={e => setSelectedHours6(e.value)}
                    ...
                    <div className="accordion-body">
                      <div className="row">
                        <div className="col-12">
                          ...
                          >
                            Input filed doesn&apos;t empty, must fill out the rule!
                          </div>
                          ...
                          <div className="file-upload-text appointment-upload">
                            <div className="input-space">
                              ...
                              <div className="file-upload">
                                ...
                                <input type="file" id="file-input" className="image-upload" />
                              </div>
                            </div>
                            ...
                            <h5>
                              Put the main picture as first Image <br /> Image Should be minimum 152
                              * 152 Supported File format JPG,PNG,SVG
                            </h5>
                          </div>
                        </div>
                      </div>
                ...
                <div className="text-center btn-row">
                  <Link className="btn btn-secondary btn-icon" to={routes.cageOrderConfirm}>
