                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-6 col-md-6">
                        <div className="input-space link-apoint">
                          <label className="form-label">Select Currency type</label>
                          <Dropdown
                      ...
                      <div className="col-lg-6 col-md-6">
                        <div className="input-space link-apoint">
                          <label className="form-label">For Onetime Appointment (USD)</label>
                          <input
                            type="text"
                      ...
                      <div className="col-md-12">
                        ...
                        <div className="file-upload-text appointment-upload">
                          ...
                          <h5>
                            Image Should be minimum 152 * 152 Supported File format JPG,PNG,SVG
                          </h5>
                        </div>
                      </div>
                          ...
                          <div className="check-single-lesson">
                            <div className="similar-player">
                              <div className="form-check d-flex align-items-center policy">
                                ...
                                <label className="form-check-label">Single Lesson</label>
                              </div>
                              <ul>
                                <li>
                            ...
                            <div className="similar-player">
                              <div className="form-check d-flex align-items-center policy">
                                ...
                                <label className="form-check-label">2 Player Lesson</label>
                              </div>
                              <ul>
                                <li>
                                  3 Days * 1 hour @ <span>$150.00</span>
                            ...
                            <div className="similar-player">
                              <div className="form-check d-flex align-items-center policy">
                                ...
                                <label className="form-check-label">Small Group Lesson</label>
                              </div>
                              <ul>
                                <li>
