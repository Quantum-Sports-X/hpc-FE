              ...
              <ul className="nav">
                ...
                <li>
                  <Link
                    ...
                    className={isLinkActive(routes.settingLesson) ? 'active' : ''}
                  >
                    Lesson
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isLinkActive(routes.settingAvalibilty) ? 'active' : ''}
                  >
                    Availability
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isLinkActive(routes.settingPassword) ? 'active' : ''}
                  >
                    Change Password
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className={isLinkActive(routes.profileOtherSetting) ? 'active' : ''}
                  >
                    Other Settings
                  </Link>
                </li>
                  ...
                  <div className="card ">
                    <form>
                      <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6">
                          <div className="input-space">
                            <label className="form-label">Type of Appointments</label>
                            <Dropdown
                        ...
                        <div className="col-lg-12 col-md-12">
                          <div className="info-about">
                            <label className="form-label">Information about You</label>
                            <textarea
                              className="form-control"
                              id="comments"
                              rows={3}
