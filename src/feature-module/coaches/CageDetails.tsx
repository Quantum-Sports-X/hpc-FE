...
const CageDetails = () => {
  ...
  const courtOptions = [{name: 'Select City'}, {name: 'Toronto'}, {name: 'Texas'}]
      ...
      <section className="booking-steps py-30">
        <div className="container">
          <ul className="d-lg-flex justify-content-center align-items-center">
            ...
            <li>
              <h5>
                <Link to={routes.cageOrderConfirm}>
                  ...
                  <div className="select-guest">
                    ...
                    <div className="d-md-flex justify-content-between align-items-center">
                      <div className="qty-item text-center">
                        ...
                        >
                          <i className="feather-minus-circle" onClick={decreaseCount} />
                        </Link>
                        <input
                          type="number"
                        ...
                        >
                          <i className="feather-plus-circle" onClick={increaseCount} />
                        </Link>
                      ...
                      <div className="qty-item text-center">
                        <Link
                          ...
                          className="dec d-flex justify-content-center align-items-center"
                        >
                          <i className="feather-minus-circle" onClick={decreaseCount2} />
                        </Link>
                        <input
                          type="number"
                          className="form-control text-center"
                        ...
                        <Link
                          ...
                          className="inc d-flex justify-content-center align-items-center"
                        >
                          <i className="feather-plus-circle" onClick={increaseCount2} />
                        </Link>
                      ...
                      <div className="qty-item text-center">
                        <Link
                          ...
                          className="dec d-flex justify-content-center align-items-center"
                        >
                          <i className="feather-minus-circle" onClick={decreaseCount3} />
                        </Link>
                        <input
                          type="number"
                          className="form-control text-center"
                        ...
                        <Link
                          ...
                          className="inc d-flex justify-content-center align-items-center"
                        >
                          <i className="feather-plus-circle" onClick={increaseCount3} />
                        </Link>
