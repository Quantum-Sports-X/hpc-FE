    ...
    <div>
      <>
                        ...
                        <div className="row align-items-center">
                          <div className="col-lg-5">
                            <div className="court-table-head">
                              <h4>Transaction</h4>
                              <p>
                                Digital wallets facilitate secure payments for coaching services.
                              </p>
                            </div>
                          </div>
        ...
        <>
                    ...
                    <div className="add-wallet-amount form-check">
                      <ul>
                        {checkboxes.map(checkbox => (
                          <li key={checkbox.id} className={checkbox.checked ? 'active' : ''}>
          ...
          {/* /Request Modal */}
          {/* Add new Modal */}
          <div className="modal custom-modal fade payment-modal" id="add-new-card" role="dialog">
            <div className="modal-dialog modal-dialog-centered modal-md">
              <div className="modal-content">
                <div className="modal-header">
                  <div className="form-header modal-header-title">
