  ...
  const courtNameRenderTwo = res => {
    return (
      <h2 className="table-avatar">
        ...
        >
          <ImageWithBasePath src={res.img} className="avatar-img" alt="Feature" />
        </Link>
        <span className="table-head-name flex-grow-1">
                    ...
                    <li>
                      <div className="appointment-item">
                        <div className="appointment-img">
                          <ImageWithBasePath src="assets/img/booking/booking-01.jpg" alt="User" />
                        </div>
                            ...
                            <td>
                              <div className="academy-info academy-coach-info">
                                ...
                                <div className="academy-content">
                                  <h6>
                                    <Link data-bs-toggle="modal" data-bs-target="#upcoming-court">
                                      Wing Sports Academy
                                    </Link>
                                  </h6>
                                  <ul>
                                    <li>Court 1</li>
                                    <li>
                                      <i className="feather-clock" /> 06:00 PM to 08:00 PM
                                    </li>
                                  </ul>
                                </div>
                              </div>
                ...
                <div className="notification-coach">
                  <div className="notify-box">
                    ...
                    <div className="notify-detail flex-grow-1">
                      <h5>
                        John Smith <span> has booked an appointment on Mon, Jul 11 </span>
                      </h5>
                  ...
                  <div className="notify-box">
                    <div className="avatar flex-shrink-0">
                      <Link to="#">
                        <ImageWithBasePath src="assets/img/booking/booking-02.jpg" alt="Booking" />
                      </Link>
                    </div>
                    <div className="notify-detail flex-grow-1">
                      <h5>
                      ...
                      <span className="hour-notify">1h ago</span>
                      <div className="notify-btn-group">
                        <Link to="#" className="btn btn-primary view-detail-btn">
                          View Details
                        </Link>
                      </div>
                    </div>
                      ...
                      <tr>
                        <td>
                          <div className="academy-info academy-info">
                            <Link to="coach-chat" className="academy-img recent-chat-img">
                              <ImageWithBasePath
                                src="assets/img/profiles/avatar-01.jpg"
                                alt="Booking"
                              />
                  ...
                  >
                    <div className="table-responsive table-datatble">
                      <DataTable className="table datatable">
                        ...
                        <Column sortable field="paidOn" body={PaidOn} header="Status"></Column>
                    ...
                    <div className="table-responsive table-datatble">
                      <DataTable className="table datatable">
                        <Column
                          ...
                          header="Court Name"
                        ></Column>
                        <Column sortable field="Invoice" header="Invoice"></Column>
                        <Column
                          sortable
                          field="dateTime"
                          body={DateTime}
