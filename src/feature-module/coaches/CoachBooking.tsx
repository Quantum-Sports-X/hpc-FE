...
const CoachBooking = () => {
  ...
  const Chat = () => {
    return (
      <div>
        <ImageWithBasePath src="assets/img/icons/chat-icon-01.svg" className="me-1" alt="Icon" />
        Chat
      </div>
    )
  }
                    ...
                    <div className="tab-content">
                      ...
                      >
                        <div className="table-responsive">
                          <DataTable className="table datatable" value={filteredData}>
                            <Column
                              sortable
                              field="courtName"
                            ...
                            <Column
                              ...
                              header="Details"
                            ></Column>
                            <Column sortable field="Details" body={Chat} header="Details"></Column>
                      ...
                      <div className="appointment-info">
                        <ul className="appointmentset">
                          ...
                          <li>
                            ...
                            <p className="text-primary fw-semibold fs-16">$200.00 / hr</p>
                          </li>
                          <li>
                            <h6>Rank</h6>
                            <p>Expert</p>
