          ...
          <div className="container">
            <div className="coach-court-list profile-court-list">
              <ul className="nav">
                ...
                <li>
                  <Link
                    to={routes.availabilitySettings}
                    className={isLinkActive(routes.availabilitySettings) ? 'active' : ''}
                  >
                    Availability
                  </Link>
                </li>
                ...
                <li>
                  <Link
                    to={routes.profileOtherSettings}
                    className={isLinkActive(routes.profileOtherSettings) ? 'active' : ''}
                  >
                    Other Settings
                  </Link>
                </li>
