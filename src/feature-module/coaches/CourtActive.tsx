                      ...
                      <div className="col-xl-6 col-lg-6 col-sm-12 col-12">
                        <div className="coach-court-list">
                          <ul className="nav">
                            ...
                            <li>
                              <Link to={routes.activeCourt} className="active">
                                Active Courts
                              </Link>
                            </li>
                            <li>
                              <Link to={routes.inactiveCourt}>Inactive Courts</Link>
                            </li>
                          </ul>
                        </div>
                      </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="table-responsive">
                        ...
                        >
                          ...
                          <Column sortable field="maxGuest" header="Max Guest"></Column>
                          <Column
                            sortable
                            field="additionalGuests"
                            header="Additional Guests"
                          ></Column>
                          <Column sortable field="addedOn" header="Added On"></Column>
                          <Column
                            sortable
                            field="details"
                            header="Details"
