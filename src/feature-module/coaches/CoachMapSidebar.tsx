...
const CoachMapSideBar = () => {
  ...
  return (
    <div>
                              ...
                              <div className="sortby-filter-group">
                                <div className="grid-listview">
                                  <ul className="nav">
                                    ...
                                    <li>
                                      <Link to={routes.coachesMapSidebar} className="active">
                                        <ImageWithBasePath
                        ...
                        <div className="listing-item listing-item-grid coach-listview">
                          ...
                          <div className="listing-content">
                            ...
                            <div className="listing-details-group">
                              <p>
                                Certified Cricket Coach with a deep understanding of the
                                sport&apos;s techniques and strategies.
                              </p>
                            </div>
                      ...
                      <div className="featured-venues-item">
                        <div className="listing-item listing-item-grid coach-listview">
                          ...
                          <div className="listing-content">
                            ...
                            <div className="listing-details-group">
                              <p>
                                Cricket coach with a passion for improving players&apos; abilities
                                and tactics.
                              </p>
                            </div>
                            <div className="avalbity-review avalbity-review-list">
      ...
      <div className={`toggle-sidebar listing-page ${isSidebarOpen ? 'open-sidebar' : ''}`}>
