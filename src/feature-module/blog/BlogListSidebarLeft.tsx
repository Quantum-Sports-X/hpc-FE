                  ...
                  <div className="listing-item">
                    ...
                    <div className="listing-content news-content">
                      ...
                      <h3 className="listing-title">
                        <Link to={routes.blogDetails}>
                          Mastering the Cricket Basics: A Guide for Beginners{' '}
                        </Link>
                      </h3>
                      <p>
                        Master the fundamentals of cricket with our beginner &apos;s guide,
                        unlocking the path to skillful play and enjoyment on the court.
                      </p>
                      <div className="listing-button read-new">
                        ...
                        <span>
                          <ImageWithBasePath src="assets/img/icons/clock.svg" alt="" />
                          10 Min To Read
                        </span>
                      </div>
                    </div>
                ...
                <div className="featured-venues-item">
                  <div className="listing-item">
                    ...
                    <div className="listing-content news-content">
                      ...
                      <h3 className="listing-title">
                        <Link to={routes.blogDetails}>
                          Unleashing Your Cricket Potential: Tips for Skill Development
                        </Link>
                      </h3>
                      <p>
                        Unlock your cricket potential and elevate your skills with our expert tips
                        for effective skill development on the court.
                      </p>
                      <div className="listing-button read-new">
                        <ul className="nav">
                          <li>
                        ...
                        <span>
                          <ImageWithBasePath src="assets/img/icons/clock.svg" alt="Icon" />5 Min To
                          Read
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="listing-item">
                    ...
                    <div className="listing-content news-content">
                      <div className="listing-venue-owner">
                        <div className="navigation">
                          <Link to="#">
                            <ImageWithBasePath src="assets/img/profiles/user-04.jpg" alt="User" />
                            Joanna Le
                          </Link>
                          <span>
                            <i className="feather-calendar" />
                      ...
                      <h3 className="listing-title">
                        <Link to={routes.blogDetails}>
                          The Art of Footwork: Enhancing Agility in Cricket
                        </Link>
                      </h3>
                      <p>
                        Master the art of footwork and elevate your agility in cricket with our
                      ...
                      <div className="listing-button read-new">
                        ...
                        <span>
                          <ImageWithBasePath src="assets/img/icons/clock.svg" alt="Icon" />4 Min To
                          Read
                        </span>
                      </div>
                    </div>
